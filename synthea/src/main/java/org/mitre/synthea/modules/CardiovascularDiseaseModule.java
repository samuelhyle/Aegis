...
public final class CardiovascularDiseaseModule extends Module {
  ...
  /**
   * Get the risk system to use for cardiovascular disease calculations.
   * Configurable via "cardiovascular.risk_system" property.
   * @return true to use Framingham, false to use ASCVD (default)
   */
  private static boolean useFramingham() {
    return Config.get("cardiovascular.risk_system", "ascvd").equalsIgnoreCase("framingham");
  }
